...
function openProfileMenu(){
  this.document.getElementById('account-menu').classList.toggle('account-menu-open');
  this.document.getElementById('account-username').classList.toggle('account-username-black');
  this.document.getElementById('menu-item-1').classList.toggle('account-menu-item-show');
  this.document.getElementById('menu-item-2').classList.toggle('account-menu-item-show');
  this.document.getElementById('menu-item-3').classList.toggle('account-menu-item-show');
}
function closeProfileMenu(){
  this.document.getElementById('account-menu').classList.remove('account-menu-open');
  this.document.getElementById('account-username').classList.remove('account-username-black');
  this.document.getElementById('menu-item-1').classList.remove('account-menu-item-show');
  this.document.getElementById('menu-item-2').classList.remove('account-menu-item-show');
  this.document.getElementById('menu-item-3').classList.remove('account-menu-item-show');
}
function bioClose(){
...
function signoutClose(){
  this.document.getElementById('sign-out-container').style.visibility = 'hidden';
  this.document.getElementById('sign-out-filter').style.visibility = 'hidden';
  this.document.body.style.overflowY = 'scroll';
  this.document.body.style.overflowX = 'hidden';
  enableScroll();
}
function signoutOpen(){
  this.document.getElementById('sign-out-container').style.visibility = 'visible';
  this.document.getElementById('sign-out-filter').style.visibility = 'visible';
  this.document.body.style.overflowY = 'scroll';
  this.document.body.style.overflowX = 'hidden';
  disableScroll();
  closeProfileMenu();
...
window.addEventListener('click', function(e){
  ...
  if (document.getElementById('account-menu').contains(e.target) == false){
    closeProfileMenu();
  }
});
  ...
  window.addEventListener('click', function(e){
    ...
    if(document.getElementById('staff1').contains(e.target)){
    ...
    else if(document.getElementById('staff13').contains(e.target)){
      disableScroll()
      ...
      fetch("https://astrocore.net/json/staff.json")
        ...
        .then(json => {
          console.log(json[13]);
          var name = json[13].name;
          var image = json[13].image;
          var text = json[13].text;
          var pos1 = json[13].pos1;
          var pos2 = json[13].pos2;
          var pos3 = json[13].pos3;
          var pos4 = json[13].pos4;
          this.document.getElementById('bio-image').src=image;
          this.document.getElementById('bio-name').innerHTML = name;
          this.document.getElementById('bio-text').innerHTML = text;
          this.document.getElementById('bio-pos1').innerHTML = pos1;
